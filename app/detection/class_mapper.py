...
CLASS_GROUPS: dict[str, ClassInfo] = {
    ...
    "elevator door": ClassInfo("porta", "porta", "f", "ponto_interesse", 98),
    ...
    "reception desk": ClassInfo("recepcao", "recepcao", "f", "ponto_interesse", 86),
    "reception area": ClassInfo("recepcao", "recepcao", "f", "ponto_interesse", 86),
    "front desk": ClassInfo("recepcao", "recepcao", "f", "ponto_interesse", 86),
    ...
    "accessibility ramp": ClassInfo("rampa acessivel", "rampa acessivel", "f", "acessibilidade", 100),
    ...
    "tactile floor": ClassInfo("piso tatil", "piso tatil", "m", "acessibilidade", 94),
    "guiding block": ClassInfo("piso tatil", "piso tatil", "m", "acessibilidade", 94),
    "warning block": ClassInfo("piso tatil", "piso tatil", "m", "acessibilidade", 94),
